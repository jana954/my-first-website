...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $stmt = $conn->prepare("UPDATE products SET 
            ...
            status = ?
            WHERE product_id = ?");
            $stmt->bind_param("ssdisssi", $name, $desc, $price, $stock, $category, $image, $status, $id);
      $stmt->execute();
    } else {
        $stmt = $conn->prepare("UPDATE products SET 
            product_name = ?, 
            ...
            status = ?
            WHERE product_id = ?");
        $stmt->bind_param("ssdissi", $name, $desc, $price, $stock, $category, $status, $id);
        $stmt->execute();
    }
...
<head>
    ...
    <title>Edit Product | RASHFA</title>
        ...
        <form method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <div class="current-image-box">
                    <p>Current Image</p>
                    <img 
                        src="images/<?= htmlspecialchars($product['image_file']) ?>" 
            ...
            <div class="btn-row">
                <button type="submit" name="update" class="btn btn-gold">Update Product</button>
